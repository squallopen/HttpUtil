...
public class SimpleTest {
    ...
    public static void main(String args[]) throws URISyntaxException, UnsupportedEncodingException {
        ...
        /*for(int i = 0; i < 100; ++i){
            String I = HttpClientPoolUtil.doGet("http://www.apache.org",null);
        }
        ...
        BasicNameValuePair vp2 = new BasicNameValuePair("你好", "后来的你好");
        list.add(vp);
        list.add(vp2);
        HttpUtil.doPost("http://127.0.0.1:9999/testClient", list);
